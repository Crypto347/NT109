...
public class Chat_Item extends javax.swing.JLayeredPane {
    ...
    public void setUserProfile(String user) {
        ...
        cmd.setForeground(new Color(109, 180, 240));
        cmd.setFont(new java.awt.Font("sansserif", 1, 12)); // NOI18N
    ...
    public void setTime(String time) {
        ...
        layer.setBorder(new EmptyBorder(0,10,10,5));
    ...
    public void sendSucces() {
        if (label != null) {
            label.setIcon(new ImageIcon(getClass().getResource("/chat/icon/check.png")));
        }
    }

    public void seen() {
        if (label != null) {
            label.setIcon(new ImageIcon(getClass().getResource("/chat/icon/read.png")));
        }
    }
    ...
    private void initComponents() {
        ...
        txt = new chat.swing.JIMSendTextPane();
    ...
    private chat.swing.JIMSendTextPane txt;
